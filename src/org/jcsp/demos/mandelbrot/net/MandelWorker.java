...
public class MandelWorker implements CSProcess {
  ...
  public static void main (String[] args) throws Exception {
  	...
  	NetSharedChannelOutput toFarmer = CNS.createAny2Net ("com.quickstone.jcsp.demos.mandelbrot.net.Farmer");
  	System.out.println ("Connecting to harvester");
  	NetSharedChannelOutput toHarvester = CNS.createAny2Net ("com.quickstone.jcsp.demos.mandelbrot.net.Harvester");
