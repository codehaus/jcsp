...
class MandelNetwork implements CSProcess {
    ...
    public MandelNetwork(final Container parent) {
        ...
        final NetAltingChannelInput workers2farmer = CNS.createNet2One ("com.quickstone.jcsp.demos.mandelbrot.net.Farmer");
        final NetAltingChannelInput workers2harvester = CNS.createNet2One ("com.quickstone.jcsp.demos.mandelbrot.net.Harvester");
