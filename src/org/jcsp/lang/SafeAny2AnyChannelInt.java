...
/**
 * This wraps up an Any2AnyChannelInt object so that its
 * input and output ends are separate objects.
 *
 * @author Quickstone Technologies Limited
 */
class SafeAny2AnyChannelInt implements Any2AnyChannelInt
{
     ...
     */
    SafeAny2AnyChannelInt(Any2AnyChannelInt chan)
    {
