...
/**
 * This wraps up a Any2OneChannel object so that its
 * input and output ends are separate objects.
 *
 * @author Quickstone Technologies Limited
 */
class SafeAny2OneChannel implements Any2OneChannel
{
     ...
     */
    SafeAny2OneChannel(Any2OneChannel chan)
    {
        in = new AltingChannelInputWrapper(chan.in());
        out = new SharedChannelOutputWrapper(chan.out());
    }
