...
/**
 * This wraps up a One2OneChannelInt object so that its
 * input and output ends are separate objects.
 *
 * @author Quickstone Technologies Limited
 */
class SafeOne2OneChannelInt implements One2OneChannelInt
{
	/** The input end. */
	 ...
	 */
	SafeOne2OneChannelInt(One2OneChannelInt chan)
        {
