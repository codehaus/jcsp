 ...
 * <code>ChannelInput</code> into a <code>ChannelOutput</code>.
 * This could potentially be done by mistake, especially in where a
 * channel is held in data structure that simply stores it as an
 ...
 */
public class RiskyChannelFactory
        implements ChannelFactory, ChannelArrayFactory, BufferedChannelFactory, BufferedChannelArrayFactory
{
    /**
     * The default instance returned by <code>getDefaultInstance</code>.
     */
    private static RiskyChannelFactory defaultInstance = new RiskyChannelFactory();

    /**
     * Constructs a new factory.
     */
    public RiskyChannelFactory()
    {
        super();
    }
     ...
     * of <code>RiskyChannelFactory</code> and return it. Subsequent
     * calls will return the same instance.</p>
     *
     * <p>This is Thread safe.</p>
     *
     * @return a static instance of <code>RiskyChannelFactory</code>.
     */
    public static RiskyChannelFactory getDefaultInstance()
    {
